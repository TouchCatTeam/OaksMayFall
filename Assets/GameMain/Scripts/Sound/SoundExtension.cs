...
namespace OaksMayFall
{
    public static class SoundExtension
    {
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, UEntity bindingUEntity = null, object userData = null)
        {
            ...
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "Sound", Constant.AssetPriority.SoundAsset, playSoundParams, bindingUEntity != null ? bindingUEntity.Entity : null, userData);
        }
