...
namespace OaksMayFall
{
    public static class ThirdPersonControllerUtility
    {
        ...
        public static void JumpAndGravity(OaksMayFallInputController input, bool grounded, ref float fallTimeoutDelta, ref float jumpTimeoutDelta, float fallTimeout, float jumpTimeout,
