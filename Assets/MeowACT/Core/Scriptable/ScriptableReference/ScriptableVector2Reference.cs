...
namespace MeowACT
{
    ...
    /// </summary>
    [Serializable]
    public class ScriptableVector2Reference
    {
        /// <summary>
        /// 是否使用字面值
        /// </summary>
        ...
        /// </summary>
        [Tooltip("可资产化值")]
        public ScriptableVector2 Variable;
        ...
        /// 可资产化二维向量值的引用的默认构造函数
        /// </summary>
        public ScriptableVector2Reference()
        { }

        /// <summary>
        /// 可资产化二维向量值的引用的使用字面值的构造函数
        /// </summary>
        /// <param name="value">字面值</param>
        public ScriptableVector2Reference(Vector2 value)
        {
            IsLiteral = true;
            LiteralValue = value;
        }
        ...
        /// <summary>
        /// 从 ScriptableVector2Reference 到 Vector2 的隐式类型转换
        /// </summary>
        /// <param name="reference">右值</param>
        /// <returns></returns>
        public static implicit operator Vector2(ScriptableVector2Reference reference)
        {
