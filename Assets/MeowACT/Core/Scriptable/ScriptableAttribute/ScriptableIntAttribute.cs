...
namespace MeowACT
{
    ...
    /// 可资产化整型角色属性
    /// </summary>
    public class ScriptableIntAttribute
    {
        /// <summary>
        /// 是否使用字面值
        /// </summary>
        ...
        /// 可资产化整型角色属性的默认构造函数
        /// </summary>
        public ScriptableIntAttribute()
        { }

        /// <summary>
        /// 可资产化整型角色属性的使用字面值的构造函数
        /// </summary>
        /// <param name="value">字面值</param>
        public ScriptableIntAttribute(int value)
        {
            IsLiteral = true;
            LiteralValue = value;
        }
        ...
        /// <summary>
        /// 从 ScriptableIntAttribute 到 int 的隐式类型转换
        /// </summary>
        /// <param name="reference">右值</param>
        /// <returns></returns>
        public static implicit operator int(ScriptableIntAttribute reference)
        {
