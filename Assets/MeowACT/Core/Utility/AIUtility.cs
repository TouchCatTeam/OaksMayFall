// ----------------------------------------------
// 作者: 廉价喵
// 创建于: 12/03/2022 14:44
// 最后一次修改于: 28/03/2022 16:42
...
namespace MeowACT
{
    ...
    public static class AIUtility
    {
        ...
        public static RelationType GetRelation(CampType first, CampType second)
        {
            ...
            // Debug.Log("Unknown relation between '{0}' and '{1}'.", first.ToString(), second.ToString());
        ...
        // public static float GetDistance(GameObject fromEntity, GameObject toEntity)
        // {
